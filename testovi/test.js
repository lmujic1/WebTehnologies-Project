...
describe('IscrtajModul', function() {
    describe('iscrtajRaspored(div, dani, satPocetak, satKraj)', function() {
        ...
        it('Test - prikaz zadnjeg sata u tabeli', function() {
            var div = document.createElement("div");
            IscrtajModul.iscrtajRaspored(div, ["Ponedjeljak", "Utorak", "Srijeda", "Četvrtak", "Petak"], 7, 24);
    ...
    describe('dodajAktivnost(raspored, naziv, tip, vrijemePocetak, vrijemeKraj, dan)', function() {
        it('Test - raspored nije kreiran', function() {
            ...
            let greska = IscrtajModul.dodajAktivnost(div1, "WT", "predavanje", 13, 15, "Ponedjeljak");
            assert.equal(greska, "Greška - raspored nije kreiran", "Raspored treba biti kreiran");
        });
        it('Test - nevalidan dan', function() {
            var div1 = document.createElement("div");
            IscrtajModul.iscrtajRaspored(div1, ["Ponedjeljak", "Utorak", "Srijeda", "Četvrtak", "Petak"], 10, 15);
            let greska = IscrtajModul.dodajAktivnost(div1, "WT", "predavanje", 13, 15, "PonedjeljakKK");
        ...
        it('Test - neispravno vrijeme (vrijemePocetak >= vrijemeKraj)', function() {
            var div1 = document.createElement("div");
            IscrtajModul.iscrtajRaspored(div1, ["Ponedjeljak", "Utorak", "Srijeda", "Četvrtak", "Petak"], 10, 15);
            let greska = IscrtajModul.dodajAktivnost(div1, "WT", "predavanje", 15, 15, "Ponedjeljak");
        ...
        it('Test - neispravno vrijeme (vrijemePocetak >= vrijemePocetakRaspored)', function() {
            var div1 = document.createElement("div");
            IscrtajModul.iscrtajRaspored(div1, ["Ponedjeljak", "Utorak", "Srijeda", "Četvrtak", "Petak"], 10, 15);
            let greska = IscrtajModul.dodajAktivnost(div1, "WT", "predavanje", 9, 15, "Ponedjeljak");
        ...
        it('Test - neispravno vrijeme (vrijemeKraj >= vrijemeKrajRaspored)', function() {
            var div1 = document.createElement("div");
            IscrtajModul.iscrtajRaspored(div1, ["Ponedjeljak", "Utorak", "Srijeda", "Četvrtak", "Petak"], 10, 15);
            let greska = IscrtajModul.dodajAktivnost(div1, "WT", "predavanje", 10, 16, "Ponedjeljak");
        ...
        it('Test - potpuno preklapanje dvije aktivnosti', function() {
            var div1 = document.createElement("div");
            IscrtajModul.iscrtajRaspored(div1, ["Ponedjeljak", "Utorak", "Srijeda", "Četvrtak", "Petak"], 10, 15);
            IscrtajModul.dodajAktivnost(div1, "RPR", "predavanje", 11, 14, "Ponedjeljak");
            let greska = IscrtajModul.dodajAktivnost(div1, "WT", "predavanje", 11, 14, "Ponedjeljak");
        ...
        it('Test - djelimično preklapanje dvije aktivnosti', function() {
            ...
            IscrtajModul.iscrtajRaspored(div1, ["Ponedjeljak", "Utorak", "Srijeda", "Četvrtak", "Petak"], 10, 15);
            IscrtajModul.dodajAktivnost(div1, "RPR", "predavanje", 11, 14, "Ponedjeljak");
            let greska = IscrtajModul.dodajAktivnost(div1, "WT", "predavanje", 13, 14.5, "Ponedjeljak");
            assert.equal(greska, "Greška - već postoji termin u rasporedu u zadanom vremenu", "Ne smije biti preklapanja aktivnosti");
        });
        it('Test - jedna aktivnost tokom čitavog  dana', function() {
            var div1 = document.createElement("div");
            IscrtajModul.iscrtajRaspored(div1, ["Ponedjeljak", "Utorak", "Srijeda", "Četvrtak", "Petak"], 10, 15);
            IscrtajModul.dodajAktivnost(div1, "RPR", "predavanje", 10, 15, "Ponedjeljak");
        ...
        it('Test - dodavanje aktivnosti na početak rasporeda', function() {
            var div1 = document.createElement("div");
            IscrtajModul.iscrtajRaspored(div1, ["Ponedjeljak", "Utorak", "Srijeda", "Četvrtak", "Petak"], 10, 15);
            IscrtajModul.dodajAktivnost(div1, "WT", "predavanje", 10, 13, "Ponedjeljak");
            var table = div1.getElementsByTagName("table")[0];
            var row = table.getElementsByTagName("tr")[1];
        ...
        it('Test - dodavanje aktivnosti na kraj rasporeda', function() {
            var div1 = document.createElement("div");
            IscrtajModul.iscrtajRaspored(div1, ["Ponedjeljak", "Utorak", "Srijeda", "Četvrtak", "Petak"], 10, 15);
            IscrtajModul.dodajAktivnost(div1, "WT", "predavanje", 13, 15, "Ponedjeljak");
            var table = div1.getElementsByTagName("table")[0];
            var row = table.getElementsByTagName("tr")[1];
